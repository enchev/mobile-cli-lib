...
import liveSyncConstants = require("../appbuilder/livesync-constants");
...
export class AndroidAppIdentifier extends deviceAppDataBaseLib.DeviceAppDataBase {
...
export class AndroidCompanionAppIdentifier extends deviceAppDataBaseLib.DeviceAppDataBase {
	constructor(_appIdentifier: string) {
...
export class AndroidNativeScriptCompanionAppIdentifier extends deviceAppDataBaseLib.DeviceAppDataBase {
	constructor(_appIdentifier: string) {
...
export class IOSAppIdentifier extends deviceAppDataBaseLib.DeviceAppDataBase {
	constructor(_appIdentifier: string) {
		super(_appIdentifier);
	}
...
export class IOSCompanionAppIdentifier extends deviceAppDataBaseLib.DeviceAppDataBase {
...
export class IOSNativeScriptCompanionAppIdentifier extends deviceAppDataBaseLib.DeviceAppDataBase {
	constructor(private servedApp: string) {
		super(NATIVESCRIPT_ION_APP_IDENTIFIER);
	}
...
export class WP8CompanionAppIdentifier extends deviceAppDataBaseLib.DeviceAppDataBase {
	constructor() {
